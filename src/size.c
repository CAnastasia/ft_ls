...
/*                                                 #+#   #+    #+    #+#      */
/*   Created: 2018/06/19 20:06:06 by canastas     #+#   ##    ##    #+#       */
/*   Updated: 2018/06/19 20:11:41 by canastas    ###    #+. /#+    ###.fr     */
/*                                                         /                  */
/*                                                        /                   */
/* ************************************************************************** */
...
void	link_size(char *root, t_list_ls *s1, int tab_size[list_size(s1)],
...
void	uid_size(char *root, t_list_ls *s1, int tab_uid[list_size(s1)],
		t_opt *options)
{
	t_stat	st;
	char	*new_root;
...
void	gid_size(char *root, t_list_ls *s1, int tab_gid[list_size(s1)],
		t_opt *options)
{
	t_stat	st;
	char	*new_root;
